...
public class MyActivity extends Activity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
      ...
      @Override public void onButtonClicked(int itemPosition, Object dataObject) {
        Log.d("faf", "ga");
        System.out.println(String.valueOf(dataObject));
      }
    });
  }
  ...
  @OnClick(R.id.center) public void center() {
    flingContainer.getTopCardListener().selectCenter();
  }
}
