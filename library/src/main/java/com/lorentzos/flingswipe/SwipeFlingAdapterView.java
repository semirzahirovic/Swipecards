...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
        ...
        flingCardListener =
            new FlingCardListener(mActiveCard, mAdapter.getItem(0), ROTATION_DEGREES,
                new FlingCardListener.FlingListener() {
                  ...
                  @Override public void onButtonClicked(Object dataObject) {
                    mOnItemClickListener.onButtonClicked(0, dataObject);
                  }
                });
  ...
  public interface OnItemClickListener {
    ...
    void onButtonClicked(int itemPosition, Object dataObject);
  }
